...
class SA_MCNN(nn.Module):
    def __init__(self, bn=False):
        ...
        self.dilated_conv1 = nn.Conv2d(64, 128, 3, stride=8, padding=6, dilation=2)
        self.dilated_conv2 = nn.Conv2d(128, 256, 3, stride=2, padding=3, dilation=2)
