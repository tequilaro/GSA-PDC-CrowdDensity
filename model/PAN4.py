...
class SA_MCNN(nn.Module):
    def __init__(self, bn=False):
        ...
        self.dilated_conv1_1 = nn.Conv2d(512, 128, 3, stride=1, padding=1)
        self.dilated_conv1_2 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self.dilated_conv2_1 = nn.Conv2d(512, 128, 3, stride=1, padding=2, dilation=2)
        self.dilated_conv2_2 = nn.Conv2d(128, 128, 3, stride=1, padding=2, dilation=2)
        self.dilated_conv3_1 = nn.Conv2d(512, 128, 3, stride=1, padding=2, dilation=2)
        self.dilated_conv3_2 = nn.Conv2d(128, 128, 3, stride=1, padding=4, dilation=4)
        self.dilated_conv4_1 = nn.Conv2d(512, 128, 3, stride=1, padding=4, dilation=4)
        self.dilated_conv4_2 = nn.Conv2d(128, 128, 3, stride=1, padding=4, dilation=4)
        ...
        self.dilated_conv1 = nn.Conv2d(256, 512, 3, stride=1, padding=2, dilation=2)
        self.dilated_conv2 = nn.Conv2d(128, 256, 3, stride=1, padding=4, dilation=4)
        self.dilated_conv3 = nn.Conv2d(64, 128, 3, stride=1, padding=8, dilation=8)
    ...
    def forward(self, x):
        ...
        x5 = self.relu(self.dilated_conv1_1(x4))
        x5 = self.relu(self.dilated_conv1_2(x5))
        x6 = self.relu(self.dilated_conv2_1(x4))
        x6 = self.relu(self.dilated_conv2_2(x6))
        x7 = self.relu(self.dilated_conv3_1(x4))
        x7 = self.relu(self.dilated_conv3_2(x7))
        x8 = self.relu(self.dilated_conv4_1(x4))
        x8 = self.relu(self.dilated_conv4_2(x8))
        
        x4 = torch.cat((x5, x6, x7, x8), 1)
        ...
        z1 = F.interpolate(z1, scale_factor = 2,  mode='bilinear')
        ...
        z2 = F.interpolate(z2, scale_factor = 2,  mode='bilinear')
